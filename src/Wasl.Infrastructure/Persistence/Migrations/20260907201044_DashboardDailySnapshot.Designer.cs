...
namespace Wasl.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260907201044_DashboardDailySnapshot")]
    partial class DashboardDailySnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wasl.Domain.Tickets.TicketComment", b =>
                {
                    ...
                    b.ToTable("TicketComments", null, t =>
                        {
                            t.HasCheckConstraint("CK_TicketComments_AuthorKind", "(AuthorKind = 'Customer' AND AuthorCustomerId IS NOT NULL) OR (AuthorKind = 'Agent' AND AuthorCustomerId IS NULL)");
            ...
            modelBuilder.Entity("Wasl.Infrastructure.Persistence.Idempotency.IdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "Endpoint", "KeyValue")
                        .IsUnique()
